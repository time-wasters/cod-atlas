...
export function calculateMapOverlayOpacity({
  baseOpacity,
  currentZoom,
  fitZoom,
  enabled,
  ...
  if (!enabled || !Number.isFinite(currentZoom) || !Number.isFinite(fitZoom)) {
    return baseOpacity;
  }
  ...
  return baseOpacity * ((1 - fadeProgress) ** FADE_CURVE_POWER);
}
