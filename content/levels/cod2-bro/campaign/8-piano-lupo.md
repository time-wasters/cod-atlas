...
mapOverlay:
  image: /images/levels/cod2-bro/campaign/8-piano-lupo/maps/briefing-map.png
  opacity: 0.72
  corners:
...
locations:
  - id: main
    ...
    city: Vizzini
    landmark: La Rosa
    latitude: 37.17565953750849
    longitude: 14.78213145383692
    precision: approximate
    confidence: high
    method: real-world-inspiration
    primary: true
    urls:
      - googleMaps: https://www.google.com/maps/search/?api=1&query=Cantigaglione+Licata,+Agrigent,+Italy
