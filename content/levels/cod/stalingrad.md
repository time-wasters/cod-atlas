...
locations:
  - id: main
    ...
    city: Volgograd
    landmark: 13th Guards landing sector at Rodimtsev's Wall
    latitude: 48.7147
    longitude: 44.5361
...
city for several days; its decisive initial crossing was made principally at
night, not at 11:00 in daylight. Contemporary summaries do support the broader
picture of a formation sent into an emergency, suffering very heavy losses and
fighting to keep the central Volga bridgehead open. The mission compresses that
sequence into one dramatic arrival.

The crossing scene also closely echoes *Enemy at the Gates*: crowded boats,
the political officer's speech, one rifle shared between two men, and troops
being shot when they retreat. A contemporary GameSpot walkthrough explicitly
noted the resemblance. These elements communicate the desperate popular image
...
and defence of this sector, and it lies behind the Stalingrad panorama complex
and Gerhardt Mill. This is the strongest identifiable real-world anchor for a
mission about that division arriving across the river. `precision: approximate`
and `confidence: medium` acknowledge that the level names only the Volga and
does not reproduce or identify a unique historical pier. The stored Google
Maps URL searches for Rodimtsev's Wall by name; the atlas marker uses the
curated coordinates above.

## Sources

- [Call of Duty Wiki: Stalingrad](https://callofduty.fandom.com/wiki/Stalingrad_%28level%29)
  — mission date, location, represented unit, objectives, and narrative.
- [Call of Duty Wiki: Stalingrad transcript](https://callofduty.fandom.com/wiki/Stalingrad_%28level%29/Transcript)
  — boat-crossing dialogue, equipment distribution, retreat scene, and route
...
- [U.S. Army Combat Studies Institute: *Block by Block: The Challenges of Urban Operations*](https://www.armyupress.army.mil/Portals/7/combat-studies-institute/csi-books/BlockByBlock_TheChallengesOfUrbanOperations.pdf)
  — 13th Guards commitment, losses, and the course of the first German assault
  in central Stalingrad.
- [Stalingrad Battle Museum-Reserve: Alexander Rodimtsev](https://stalingrad-battle.ru/history/people-time/4356/)
  — museum account of Rodimtsev, the division's crossing, immediate entry into
  combat in the city centre, and its Volga-bank defence.
- [Stalingrad Battle Museum-Reserve: Gerhardt/Grudinin Mill](https://stalingrad-battle.ru/qr/ruiny-melnitsy-im-grudinina.php)
  — the mill's role as the 42nd Guards Rifle Regiment commander's observation
  post and a central defensive strongpoint.
- [13th Guards Poltavaskaya history project](https://www.13thguardspoltavaskaya.com/history.html)
  — detailed identification of the 42nd Regiment's landing sector and
  Rodimtsev's Wall; used as supporting local-placement evidence.
- [OpenStreetMap: Rodimtsev's Wall marker](https://www.openstreetmap.org/?mlat=48.7147&mlon=44.5361#map=18/48.7147/44.5361)
