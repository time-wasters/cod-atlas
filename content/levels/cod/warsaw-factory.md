---
id: cod-warsaw-factory
title: Warsaw Factory
games:
  - cod
mode: singleplayer
...
locations:
  - id: main
    ...
    city: Warsaw
    landmark: Former Ursus Mechanical Works (Waverma)
    latitude: 52.19765
    longitude: 20.8829
    precision: exact
    confidence: medium
...
and part of its workforce to the Wrocław area. The grounds were then used as a
transit camp for Warsaw residents expelled after the uprising. By early 1945
German troops had mined the complex; Home Army soldiers defused most of the
charges, although some buildings were destroyed. This history supports a
...
conducted most of the urban fighting. The 3rd Shock Army was then a reserve of
the 1st Belorussian Front, rather than the force clearing Warsaw. The 150th
...
site literally. No reviewed source connects Infinity Ward's designers to the
Ursus works, and the level may instead be a fictional industrial composite.
The marker nevertheless identifies the closest functional and geographic
candidate found, at a surviving interwar factory building on Dyrekcyjna
Street. `confidence: medium` records that interpretive uncertainty. The stored
Google Maps URL searches for the named former factory; the atlas marker itself
uses the curated coordinates above.

## Sources

- [Call of Duty Wiki: Warsaw Factory](https://callofduty.fandom.com/wiki/Warsaw_Factory)
  — mission date, place, player character, represented unit, objectives, and
  campaign sequence.
- [Call of Duty Wiki: Warsaw Factory transcript](https://callofduty.fandom.com/wiki/Warsaw_Factory/Transcript)
  — briefing references to manufacturing districts, tank repair, factories,
  railway yards, and the 150th Rifle Division and 3rd Shock Army.
- [Ursus History Centre: former Ursus Mechanical Works heritage complex](https://ursushistoryczny.pl/aktualnosci/zespol-budowlany-d-zakladow-mechanicznych-ursus-wreszcie-w-rejestrze-zabytkow/)
  — factory layout and ownership, the Waverma tank-repair role, 1944
  evacuation and transit camp, mining, Home Army clearance, and postwar
  history.
- [Warsaw Ursus District: Ursus during and after the war](https://ursus.um.warszawa.pl/-/ursus-czas-wojny-i-po)
  — municipal history of the occupied factory, German preparations to destroy
  it, and preservation by the Home Army's “Torpeda” platoon.
...
- [Wikimedia Commons: Ursus model shop](https://commons.wikimedia.org/wiki/Category:Modelarnia_(Ursus_Factory))
  — geolocated record of the surviving interwar factory building used for the
  marker.
- [OpenStreetMap: former Ursus works](https://www.openstreetmap.org/?mlat=52.19765&mlon=20.8829#map=17/52.19765/20.8829)
  — present-day geographic context for the curated coordinates and adjacent
  railway.
