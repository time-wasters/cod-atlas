---
id: cod-oder-river-country
title: Oder River Country
games:
  - cod
mode: singleplayer
...
locations:
  - id: main
    ...
    landmark: Genschmar sector of the Oder front
    latitude: 52.611944
    longitude: 14.539444
...
tanks around streams and a bridge, survives Panzerfaust ambushes in a forest,
...
wooded patches, villages, and minor crossings is also a credible geographic
analogue for the level's terrain.

The broader Küstrin sector fits the campaign's direction toward Berlin. The
...
bridgehead near Genschmar followed at the beginning of February. The game's
large meeting engagement with numerous Tiger and Panzer IV tanks is likewise
not securely tied to a battle at Genschmar. Contemporary operational studies
instead emphasize the speed of the Soviet exploitation and the initially thin,
improvised German defence of the Oder crossings.

The “less than 70 kilometres” statement should also be read as an approximate
dramatic claim rather than surveying evidence. Depending on whether distance
is measured from the river, nearby Kienitz, or Küstrin—and whether the target
...
appear to form a generalized Oder-front landscape. The marker at
`52.611944, 14.539444` therefore represents the Genschmar sector rather than a
claimed exact tank position. `precision: approximate` and `confidence: medium`
record both the strong unit-and-campaign match and the uncertainty in the
fictional geography. The stored Google Maps URL searches for Genschmar as a
named real place; the atlas marker uses the curated coordinates above.

## Sources

- [Call of Duty Wiki: Oder River Country](https://callofduty.fandom.com/wiki/Oder_River_Country)
  — mission date, location, player character, 2nd Guards Tank Army, objective,
  briefing, terrain, and armored engagements.
- [Call of Duty Wiki: Oder River Country transcript](https://callofduty.fandom.com/wiki/Oder_River_Country/Transcript)
  — briefing text and in-mission dialogue supporting the approach to the Oder
  and Berlin-distance claim.
...
- [War History: Küstrin 1945, part I](https://warhistory.org/es/article/kustrin-1945-part-i?amp=1)
  — arrival of the 2nd Guards Tank Army's 1st Mechanized Corps and the 19th
  Motorized Rifle Brigade bridgehead near Genschmar.
- [Bleyen-Genschmar municipal location](https://www.wikidata.org/wiki/Q583124)
  — named modern municipality containing Genschmar and geographic reference
  for the marker.
- [OpenStreetMap: Genschmar sector](https://www.openstreetmap.org/?mlat=52.611944&mlon=14.539444#map=13/52.611944/14.539444)
  — present-day terrain and geographic relationship to the Oder.
